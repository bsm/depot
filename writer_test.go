...
func TestWriter(t *testing.T) {
	t.Run("writes plain", func(t *testing.T) {
		...
		info := testWriter(t, obj, &depot.WriterOptions{
			Version: 101,
		})
		...
		meta := bfs.Metadata{"X-Depot-Version": "101"}
...
func testWriter(t *testing.T, obj *bfs.Object, opts *depot.WriterOptions) *bfs.MetaInfo {
	t.Helper()

	w := depot.NewWriter(t.Context(), obj, opts)
