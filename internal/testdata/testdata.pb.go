...
type MockMessage struct {
	...
	Enum   MockEnum `protobuf:"varint,2,opt,name=enum,proto3,enum=depot.internal.testdata.MockEnum" json:"enum,omitempty"`
...
var file_internal_testdata_testdata_proto_goTypes = []interface{}{
	(MockEnum)(0),       // 0: depot.internal.testdata.MockEnum
	(*MockMessage)(nil), // 1: depot.internal.testdata.MockMessage
}
var file_internal_testdata_testdata_proto_depIdxs = []int32{
	0, // 0: depot.internal.testdata.MockMessage.enum:type_name -> depot.internal.testdata.MockEnum
