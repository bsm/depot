...
import (
	...
	"github.com/bsm/depot/internal/pbio"
	"github.com/fxamacker/cbor/v2"
	"google.golang.org/protobuf/proto"
)

var errNoFormat = errors.New("depot: no format detected")
...
func (w *protobufWrapper) Decode(v any) error {
	switch msg := v.(type) {
	case proto.Message:
		if w.dec == nil {
...
func (w *protobufWrapper) Encode(v any) error {
	switch msg := v.(type) {
	case proto.Message:
		if w.enc == nil {
